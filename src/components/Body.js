...
export default function Body(props){
    ...
    return(
        <div>
            { props.display === 'game' && 
                <Input easy={props.easy} guess={guess} setGuess={setGuess} guesses={guesses} setGuesses={setGuesses} 
                    answer={props.answer} color={props.color} displaySettings={props.displaySettings} displayTutorial={props.displayTutorial}/> 
            }
            { props.display === 'full' && 
            ...
            { props.display === 'game' && 
                <Guesses color={props.color} guesses={guesses}/>
            }
        </div>
    )
}